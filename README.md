...
This project includes the code for BriVL/CLIP to generate images using VQGAN and DALLE, which is the image generation part of our paper [**New Audio Representations Image Gan Generation from BriVL**](https://arxiv.org/abs/2303.04585).
